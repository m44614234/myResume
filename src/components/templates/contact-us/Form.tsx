    ...
    >
      ...
      <div className={`${styles.groups} , flex-wrap`}>
        <div className={styles.group}>
          <label className="text-gray-800 dark:text-gray-300">{c("name")}</label>
          <input
            type="text"
            value={name}
        ...
        <div className={styles.group}>
          <label className="text-gray-800 dark:text-gray-300">{c("email")}</label>
          <input
            type="text"
            value={email}
      ...
      <div className={`${styles.groups} , flex-wrap`}>
        <div className={styles.group}>
          <label className="text-gray-800 dark:text-gray-300">{c("mobile")}</label>
          <input
            type="number"
            value={phone}
      ...
      <div className={styles.group}>
        <label className="text-gray-800 dark:text-gray-300">{c("message")}</label>
        <textarea
          name=""
          id=""
          value={message}
      ...
      <button className="mb-8" onClick={submitMessage}>{locale === 'id' ? "ارسال پیام" : "send message"}</button>
    </form>
  );
};
